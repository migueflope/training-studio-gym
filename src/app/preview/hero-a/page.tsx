import { HeroTrainers } from "@/components/landing/HeroTrainers";
...
export default async function HeroAPreview() {
  ...
  return (
    <div className="flex flex-col w-full">
      <ParticleField />
      <HeroTrainers badge={cms.hero_title} subtitle={cms.hero_subtitle} />
